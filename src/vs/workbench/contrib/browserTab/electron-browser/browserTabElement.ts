...
import { WebviewResourceRequestManager } from 'vs/workbench/contrib/webview/electron-sandbox/resourceLoading';
import { IWorkbenchEnvironmentService } from 'vs/workbench/services/environment/common/environmentService';

export class BrowserTabWebview extends BaseWebview<WebviewTag> implements Webview, WebviewFindDelegate {
	...
	constructor(
		...
		*/
		...
		this._register(addDisposableListener(this.element!, 'dom-ready', once(() => {
			this._register(BrowserTabWebview.getWebviewKeyboardHandler(configurationService, mainProcessService).add(this.element!));
		})));
		...
		this.element!.src = 'https://www.google.com';
	}
	...
	protected createElement(options: WebviewOptions) {
		...
		element.setAttribute('partition', 'browser');
